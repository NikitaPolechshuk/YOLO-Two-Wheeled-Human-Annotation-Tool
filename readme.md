...
<details>
<summary><small>Легенда цветов разметки</small></summary>

<small>
  
- 🟡 **Желтый прямоугольник** - обнаруженный человек  
- 🔵 **Синий прямоугольник** - двухколесный транспорт (велосипед/мотоцикл)  
- 🔴 **Красный прямоугольник** - объединенная область (человек + транспорт)  
